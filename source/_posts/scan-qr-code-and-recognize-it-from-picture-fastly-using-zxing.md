...
zxing寻找最佳预览尺寸的前三步剔除了部分不符合要求的尺寸集合，在最后一步，如果没有精确匹配到与屏幕分辨率一样的尺寸，则使用最大的尺寸。问题的关键就在这里，**最大的尺寸宽高比与屏幕宽高比相差可能很大（根据剔除规则，差距可能超过15%）。**
